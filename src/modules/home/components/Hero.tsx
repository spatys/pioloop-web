...
export const Hero: React.FC<HeroProps> = ({ className = "" }) => {
  ...
  return (
    <section className={`relative bg-amber-50 overflow-hidden ${className}`}>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                Une plateforme 100% en ligne et un modèle de location unique qui
                seront les clés de votre réussite.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <BoutonLink href="/register-email" variant="default" size="lg">
