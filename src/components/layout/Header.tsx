            ...
            <div className="relative user-menu-container">
              {user ? (
                ...
                <button
                  ...
                  className="flex items-center space-x-2 text-gray-700 hover:text-purple-600 transition-all duration-200 p-1 rounded-lg hover:bg-gray-50"
                >
                ...
                <button
                  onClick={() => setIsUserMenuOpen(!isUserMenuOpen)}
                  className="flex items-center space-x-2 bg-white border border-gray-300 rounded-lg px-3 py-2 text-gray-700 hover:border-purple-500 transition-all duration-200"
                >
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 py-4 z-50">
                  ...
                  <div className="px-0 py-2">
                    <Link
                      href="/profile"
                      className="flex items-center space-x-3 py-3 px-4 text-sm text-gray-900 hover:bg-gray-50 rounded-lg transition-colors duration-200 w-full"
                    >
                  ...
                  <div className="px-4 py-2 border-t border-gray-200">
                    {user ? (
                      <button
                        onClick={logout}
                        className="flex items-center space-x-3 py-3 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 w-full text-left"
                      >
                      ...
                      <Link
                        href="/login"
                        className="flex items-center space-x-3 py-3 px-4 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 w-full"
                      >
                        <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
