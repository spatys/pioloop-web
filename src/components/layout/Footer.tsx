        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-display font-bold">Pioloop</span>
            </Link>
        ...
        <div className="border-t border-secondary-800 pt-8 mb-8">
          <div className="max-w-md">
            ...
            <div className="flex space-x-3">
              ...
              />
              <button className="px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-xl transition-colors duration-200">
                S'abonner
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-secondary-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6 text-sm text-secondary-400">
              <span>&copy; {currentYear} Pioloop. Tous droits réservés.</span>
              <span>•</span>
              <span>Fabriqué avec ❤️ en France</span>
            </div>
            
            <div className="flex items-center space-x-6">
              <select className="bg-secondary-800 border border-secondary-700 rounded-lg px-3 py-2 text-sm text-secondary-300 focus:outline-none focus:ring-2 focus:ring-primary-500">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-sm text-secondary-400">Paiement sécurisé</span>
                <div className="flex space-x-2">
                  <svg className="w-8 h-5 text-secondary-600" viewBox="0 0 32 20">
