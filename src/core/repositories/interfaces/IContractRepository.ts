...
export interface IContractRepository {
  ...
  updateContract(id: string, data: UpdateContractForm): Promise<ApiResponse<Contract>>;
  ...
  updateContractStatus(id: string, status: string, reason?: string): Promise<ApiResponse<Contract>>;
  signContract(id: string, signatureType: 'tenant' | 'owner'): Promise<ApiResponse<Contract>>;
  
  // Contract validation
  validateContract(data: CreateContractForm): Promise<ApiResponse<{ isValid: boolean; errors: string[] }>>;
