...
class InvoiceRepository implements IInvoiceRepository {
  ...
  async getInvoices(filters?: any): Promise<PaginatedResponse<Invoice>> {
    const queryParams = filters
      ...
      : "";
    const response = await this.httpClient.get<PaginatedResponse<Invoice>>(
  ...
  async getInvoicesByProperty(
    ...
    return await this.httpClient.get<Invoice[]>(
      `/invoices/property/${propertyId}`,
    );
  }
  ...
  async updateInvoiceStatus(
    ...
    return await this.httpClient.put<Invoice>(`/invoices/${id}/status`, {
      status,
    });
  }
  ...
  async markInvoiceAsPaid(
    ...
    return await this.httpClient.put<Invoice>(`/invoices/${id}/paid`, {
      paidAt,
    });
  }

  async generateInvoice(reservationId: string): Promise<ApiResponse<Invoice>> {
    return await this.httpClient.post<Invoice>(
