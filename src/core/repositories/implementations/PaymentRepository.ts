...
class PaymentRepository implements IPaymentRepository {
  ...
  async getPayments(filters?: any): Promise<PaginatedResponse<Payment>> {
    const queryParams = filters
      ...
      : "";
    const response = await this.httpClient.get<PaginatedResponse<Payment>>(
  ...
  async getPaymentsByReservation(
    ...
    return await this.httpClient.get<Payment[]>(
      `/payments/reservation/${reservationId}`,
    );
  }

  async processPayment(
    data: ProcessPaymentForm,
  ): Promise<ApiResponse<Payment>> {
    return await this.httpClient.put<Payment>(
      `/payments/${data.paymentId}/process`,
      data,
    );
  }
  ...
  async updatePaymentStatus(
    ...
    return await this.httpClient.put<Payment>(`/payments/${id}/status`, {
      status,
    });
  }
  ...
  async createStripePaymentIntent(
    ...
    return await this.httpClient.post<{ clientSecret: string }>(
  ...
  async confirmStripePayment(
    ...
    return await this.httpClient.post<Payment>("/payments/stripe/confirm", {
      paymentIntentId,
    });
  }
  ...
  async validatePayment(
    ...
    return await this.httpClient.post<{ isValid: boolean; errors: string[] }>(
      "/payments/validate",
      data,
    );
  }
