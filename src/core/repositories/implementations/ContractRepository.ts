...
class ContractRepository implements IContractRepository {
  ...
  async getContracts(filters?: any): Promise<PaginatedResponse<Contract>> {
    const queryParams = filters
      ...
      : "";
    const response = await this.httpClient.get<PaginatedResponse<Contract>>(
  ...
  async getContractsByTenant(
    ...
    return await this.httpClient.get<Contract[]>(
  ...
  async updateContractStatus(
    ...
    return await this.httpClient.patch<Contract>(`/contracts/${id}/status`, {
      status,
      reason,
    });
  }
  ...
  async signContract(
    ...
    return await this.httpClient.post<Contract>(`/contracts/${id}/sign`, {
      signatureType,
    });
  }
