...
export interface IPropertyService {
  ...
  getProperties(filters?: PropertyFilters): Promise<PaginatedResponse<Property>>;
  ...
  searchProperties(searchParams: PropertySearchForm): Promise<PaginatedResponse<Property>>;
  ...
  getPropertyAnalytics(propertyId: string, dateRange?: { start: Date; end: Date }): Promise<any>;
  ...
  // Property images
  uploadPropertyImages(propertyId: string, files: File[]): Promise<{ imageUrls: string[] }>;
  ...
  // Property validation
  validatePropertyData(propertyData: any): Promise<{ isValid: boolean; errors: string[] }>;
  validatePropertyImages(files: File[]): Promise<{ isValid: boolean; errors: string[] }>;
