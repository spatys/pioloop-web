...
export interface IContractService {
  ...
  updateContractStatus(id: string, status: string, reason?: string): Promise<Contract>;
  signContract(id: string, signatureType: 'tenant' | 'owner'): Promise<Contract>;
  
  // Contract validation
  validateContract(data: CreateContractForm): Promise<{ isValid: boolean; errors: string[] }>;
  ...
  applyContractTemplate(contractId: string, templateId: string): Promise<Contract>;
} 